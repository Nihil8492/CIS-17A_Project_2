...
int main(int argc, char** argv) {
    ...
    do
    {
        ...
        {
        cin >> choice;
        if(cin.fail()){throw invalid_argument("Invalid input, please enter a relevant integer.");}
        }
...
void mainGameLoop(short *rcrdPtr, char *colorOrd, char colorSel, string name, player *playerList, bool *playerTurn,troublePlayerFunctions playerObj[])
{
    ...
    debugPlayerInherited1<int> debug1;
    debugPlayerInherited2<int> debug2;
    ...
    do
    {
        ...
        for(whoseTurn = 0; whoseTurn < 4; whoseTurn++)
        {
            if(debug)
            {
                cout << "This is an example of many features I couldn't"
                        << " think of uses for in the main program." << endl << endl;
                int a = debug1.virtclass();
                int b = debug2.virtclass();
                
                vector<int> v = {16,-451,22,5,0};
                ...
                if(a!=b)
                {
                    cout << "The overridden virtual functions return different values, as they should." << endl;
                }
                
                debugPlayerInherited2<int> debug3 = debug2;
...
void getVal(friendDemo a)
{
    cout << "The protected value is: " << a.exVal2 << endl << endl;
}